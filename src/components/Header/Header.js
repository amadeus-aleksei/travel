        ...
        <header className='header'>
            ...
            <nav className="user-nav">
                <div className="user-nav__icon-box">
                    <svg version="1.1" xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 20 20" className="user-nav__icon">
                ...
                <div className="user-nav__user">
                    <img src={require('../../img/user.png')} alt="User" class="user-nav__user-photo"/>
                    <span class='user-nav__username'>Amadeus</span>
                </div>
            </nav>
        </header> 
    )
